...
struct Converter
{
    ...
    // convert cv::Mat to Eigen::Vector3d
    ...
    // convert Eigen::Matrix4d to Eigen::Matrix<double, 7, 1> for local BA and loop closure
    ...
    // convert Eigen::Matrix<double, 7, 1> to Eigen::Matrix4d for local BA and loop closure
