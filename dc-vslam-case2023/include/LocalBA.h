...
class LocalMapper
{
    ...
    public:
        ...
        // reprojection threshold for outliers
        const float reprjThreshold {7.815f};

        // max size of active keyframes
        const int actvKFMaxSize {10};
        // minimum count of matches for a mappoint to be considered correct
        ...
        FeatureMatcher* fm;
        // intrinsic parameters for easier access
