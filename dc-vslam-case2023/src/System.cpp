...
// constructor, start all threads for Dual Camera Setup
...
// save the trajectory after system exit
void System::saveTrajectory(const std::string& filepath)
{
    ...
    // loop through all frame poses and update the ones that are not keyframes using the reference pose calculated
    ...
    for ( it = allFrames.begin(); it != end; it ++)
    {
        ...
        // save to datafile in KITII Dataset Format
...
// save the trajectory and position after system exit
